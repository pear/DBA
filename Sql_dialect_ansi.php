...
$dialect = array(
    ...
    'operators'=>'= <> < <= > >= like clike slike not is in between',
    ...
    'functions'=>'avg count max min sum nextval currval',
...
$typeMap = array('decimal'=>'numeric', 'dec'=>'numeric', 'numeric'=>'numeric',
                 'float'=>'float', 'real'=>'real', 'double'=>'real',
                 'integer'=>'int', 'integer'=>'int', 'interval'=>'interval',
                 'smallint'=>'smallint','timestamp'=>'timestamp','bool'=>'bool',
                 'boolean'=>'bool','set'=>'set','enum'=>'enum','text'=>'text',
                 'char'=>'char','character'=>'char','varchar'=>'varchar');
?>
